...
export const PROJECTS = [
  {
    ...
    detail: {
      ...
      focus: {
        ...
        ownership:
          "需求拆解、流程建模、交互原型、冲突规则设计、名单导入策略、Supabase 数据结构设计与上线验证。",
        flowSummary:
...

  {
    ...
    detail: {
      focus: {
        ...
        ownership:
          "订阅场景梳理、主题分桶策略、摘要结构定义、定时推送策略、结果验收口径与迭代优先级管理。",
        flowSummary:
...

  {
    ...
    detail: {
      focus: {
        ...
        ownership:
          "需求与约束梳理、贪心拆分规则定义、批量导入导出流程设计、异常校验策略、网页与小程序形态对齐。",
        flowSummary:
...

  {
    ...
    detail: {
      focus: {
        ...
        ownership:
          "场景需求拆分、汇率口径定义、换算防呆规则设计、交互流程与异常提示设计、弱网与缓存策略验证。",
        flowSummary:
...

  {
    ...
    detail: {
      focus: {
        ...
        ownership:
          "业务规则抽象、模板字段映射、异常校验定义、自动化流程编排、产物验收标准制定与上线迭代。",
        flowSummary:
