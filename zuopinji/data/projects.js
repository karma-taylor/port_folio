...
export const PROJECTS = [
  {
    ...
    outcomes: [
      "把分段冲突前置到保存前，减少排班撞期与返工沟通",
      "让名单与工单状态跨设备恢复，降低换电脑或清缓存带来的中断",
    ],
    cover: {
    ...
    detail: {
      ...
      summary:
        "面向施工与运维排班场景的可视化日历工具。它真正解决的不是“做一个日历”，而是把人、工期、角色、冲突这些复杂约束抽象成用户能理解、系统能执行的排班规则。",
      prompt:
...
export const PROFILE = {
  ...
  description:
    "郭伟南的 AI 产品经理作品集：聚焦真实业务场景中的规则抽象、AI 工作流设计与产品落地，包括工作日历排班、HamHome 资讯日报、薪资分配策略、汇率换算 Agent 与日报自动化。",
};
