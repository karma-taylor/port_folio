...
const CASE_ENHANCEMENTS = {
  ...
  money: {
    ...
    solution:
      "用从大到小的贪心策略完成拆分，统一单笔与批量口径；取舍上优先保证导入导出链路和复核稳定性，而不是复杂交互装饰。",
    results: [
      { label: "交付形态", value: "网页工具 + 小程序版本" },
      { label: "验证方式", value: "单笔与批量名单试跑" },
      { label: "效率变化", value: "约 30 分钟压到 3 分钟级" },
      { label: "质量口径", value: "余数与异常行可复核" },
      { label: "当前状态", value: "已上线" },
      { label: "结果说明", value: "Excel 批量导入导出" },
    ],
    risks:
      "当前策略以固定面额组为主，更复杂的库存约束与多轮调拨还没纳入；小程序批量链路仍可继续打磨。",
    retro:
      "这类工具的关键不是“算法多复杂”，而是结果口径一致、导出可交付、异常可解释，先把这些做稳收益最大。",
  },
  fx: {
    background:
